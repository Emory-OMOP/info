...
hide:
  - footer
title: "NLP Infrastructure"
---

# NLP Infrastructure

!!! danger "Draft — Internal Review Only"

    This document is a **working draft** intended for internal review by the Enterprise OMOP implementation team and BMI collaborators. It has not been finalized, peer-reviewed, or approved for external distribution. Schema details, table names, and implementation guidance are subject to change.
