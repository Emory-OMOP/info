...
An LLM tool that classifies OHDSI vocabulary mappings as uphill,
downhill, equal, or incorrect — currently focused on ICD10CM
conditions but adaptable to other domains. Complements our Custom
Vocabulary Builder's LLM-assisted mapping review.
